...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/modulizationorganization/B_Category"
  ...
  s.source       = { :git => "https://github.com/modulizationorganization/B_Category.git", :tag => s.version.to_s }
