...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/modulizationorganization/A_Category"
  ...
  s.source       = { :git => "https://github.com/modulizationorganization/A_Category.git", :tag => s.version.to_s }
